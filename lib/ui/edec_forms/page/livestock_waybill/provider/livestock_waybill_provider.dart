...
class LivestockWaybillNotifier extends BaseModel {
  ...
  final pdfs = {
    'sa': 'https://pir.sa.gov.au/__data/assets/pdf_file/0005/265082/Alternative_Cattle_Movement_Document_nov_2015.pdf',
    // 'NT': 'https://nt.gov.au/__data/assets/pdf_file/0011/209387/example-of-how-to-fill-in-a-.pdf',
    'nt': 'https://nt.gov.au/__data/assets/pdf_file/0011/209387/example-of-how-to-fill-in-a-waybill.pdf',
    'QLD': 'https://www.daf.qld.gov.au/__data/assets/pdf_file/0004/377806/BQ-0083-Movement-record.pdf',
    'WA':
  ...
  Future<void> selectState(String? state) async {
    ...
    if (value?.isNotEmpty ?? true) {
      ...
      isPdf ? await _downloadPdf(value) : Get.to(() => Webview(url: value, title: 'Livestock Waybill'));
    } else {
  ...
  Future<void> _downloadPdf(String url) async {
    ...
    try {
      ...
      final file = await _formsStorageService.downloadPdf(bytes: result, fileName: '$selectedState Waybill');
